...
- Both budgets tightened rather than moved: the compiler bundle is 34,478 B gzip against its 34,816 B ceiling, leaving 338 B where 0.6.0 left 882 B. The router arena accounts for 413 B of that and the writer 171 B; 40 B came back from the two changes above. Recorded here rather than absorbed, and no budget was raised to accommodate it.
